...
class TicketsController extends Controller
{
    ...
    {
        $user = $this->agent->find(Sentry::getUser()->id);
        ...
        $collection
            ...
            ->select([
                ...
                DB::raw('concat(users.last_name, " ", users.first_name) as owner'),
                'ticketit.agent_id',
                'ticketit_categories.name AS category ORDER BY updated_at ASC',
            ]);
    ...
    public function renderTicketTable(EloquentEngine $collection)
    {
        ...
        $collection->editColumn('agent', function ($ticket) {
            ...
            $name=$ticket->agent->last_name." ".$ticket->agent->first_name;
