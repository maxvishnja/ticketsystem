...
{{-- // END Modal Window: 1/2 --}}
            ...
            <div class="panel well well-sm">
                <div class="panel-body">
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <p> <strong>{{ trans('ticketit::lang.owner') }}</strong>{{ trans('ticketit::lang.colon') }}{{ $ticket->user->last_name.' '.$ticket->user->first_name }}</p>
                            <p>
                                ...
                                @if( $ticket->isComplete() && ! $setting->grab('default_close_status_id') )
                                    <span style="color: blue">{{ trans('ticketit::lang.complete-body') }}</span>
                                @else
                        ...
                        <div class="col-md-6">
                            <p> <strong>{{ trans('ticketit::lang.responsible') }}</strong>{{ trans('ticketit::lang.colon') }}{{ $ticket->agent->last_name.' '.$ticket->agent->first_name }}</p>
                            <p>
