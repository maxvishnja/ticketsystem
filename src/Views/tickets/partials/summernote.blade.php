...
<script>
    ...
    $(function() {
        ...
        var options = $.extend(true, {height: 200, lang: '{{$editor_locale}}' {!! $codemirror_enabled ? ", codemirror: {theme: '{$codemirror_theme}', mode: 'text/html',  htmlMode: true,  lineWrapping: true}" : ''  !!} } , {!! $editor_options !!});
